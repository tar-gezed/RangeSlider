...
class RangeSliderUI extends BasicSliderUI {
	 ...
	 * thumb is dragged to repaint the slider. The <code>setThumbLocation()</code> method performs
	 * the same task for the lower thumb.
	 */
	...
	/**
	 * Moves the selected thumb in the specified direction by a block increment. This method is
	 * called when the user presses the Page Up or Down keys.
	 */
	@Override
	...
	/**
	 * Moves the selected thumb in the specified direction by a unit increment. This method is
